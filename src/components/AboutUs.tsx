...
const AboutUs = () => {
  const team = [
    ...
    },
    {
      ...
      description: "Thomas Burkert ist verantwortlich für den Bereich Technologie und Innovation bei BURKERT&BURKART. Mit seiner Expertise in IT-Infrastruktur und Künstlicher Intelligenz unterstützt er Kunden bei der digitalen Transformation. Zuvor war er CTO bei einem führenden Berliner Technologieunternehmen. Er hat einen Master in Informatik von der TU Berlin.",
      email: "t.burkert@burkertburkart.de",
